...
public class PantsGetter_ : MonoBehaviour
{
    ...
    private void Start()
    {
        vaccumedableGirlControllers = Player_GirlManager_.instance.vaccumedableGirlControllers;
    ...
    public void OnVacuumRelease()
    {
        ...
        foreach (var girl in vaccumedableGirlControllers)
        {
            if(girl.currentState == GirlController_.State.Damaged)
            {
                return;
            }
